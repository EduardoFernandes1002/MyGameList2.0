...
CREATE TABLE IF NOT EXISTS `gamelistTEST`.`t_permissao` (
  ...
  UNIQUE INDEX `nmPermissao_UNIQUE` (`nm_permissao` ASC) )
ENGINE = InnoDB
AUTO_INCREMENT = 3
...
CREATE TABLE IF NOT EXISTS `gamelistTEST`.`t_usuario` (
  ...
  UNIQUE INDEX `nm_apelido_UNIQUE` (`nm_apelido` ASC) ,
  UNIQUE INDEX `ds_email_UNIQUE` (`ds_email` ASC) ,
  UNIQUE INDEX `nr_telefone_UNIQUE` (`nr_telefone` ASC) ,
  INDEX `fk_T_USUARIO_T_PERMISSAO1_idx` (`id_permissao` ASC) ,
...
CREATE TABLE IF NOT EXISTS `gamelistTEST`.`t_desenvolvedora` (
  ...
  UNIQUE INDEX `nm_desenvolvedora_UNIQUE` (`nm_desenvolvedora` ASC) )
ENGINE = InnoDB
AUTO_INCREMENT = 12
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `gamelistTEST`.`t_distribuidora` (
  ...
  UNIQUE INDEX `nm_distribuidora_UNIQUE` (`nm_distribuidora` ASC) )
ENGINE = InnoDB
AUTO_INCREMENT = 16
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `gamelistTEST`.`t_jogo` (
  ...
  PRIMARY KEY (`id_jogo`),
  UNIQUE INDEX `nm_jogo_UNIQUE` (`nm_jogo` ASC) ,
  UNIQUE INDEX `ds_imagem_UNIQUE` (`ds_imagem` ASC) ,
  INDEX `fk_T_JOGO_T_DISTRIBUIDORA1_idx` (`id_distribuidora` ASC) ,
  INDEX `fk_T_JOGO_T_DESENVOLVEDORA1_idx` (`id_desenvolvedora` ASC) ,
...
CREATE TABLE IF NOT EXISTS `gamelistTEST`.`t_genero_do_jogo` (
  ...
  INDEX `fk_T_JOGO_has_T_GENERO_T_GENERO1_idx` (`id_genero` ASC) ,
  INDEX `fk_T_JOGO_has_T_GENERO_T_JOGO1_idx` (`id_jogo` ASC) ,
...
CREATE TABLE IF NOT EXISTS `gamelistTEST`.`t_lista` (
  ...
  UNIQUE INDEX `nm_lista_UNIQUE` (`nm_lista` ASC) )
ENGINE = InnoDB
AUTO_INCREMENT = 7
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `gamelistTEST`.`t_modo` (
  ...
  PRIMARY KEY (`id_modo`),
  UNIQUE INDEX `nm_modo_UNIQUE` (`nm_modo` ASC) )
ENGINE = InnoDB
AUTO_INCREMENT = 6
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `gamelistTEST`.`t_modo_de_jogo` (
  ...
  INDEX `fk_T_JOGO_has_T_MODO_JOGO_T_MODO_JOGO1_idx` (`id_modo` ASC) ,
  INDEX `fk_T_JOGO_has_T_MODO_JOGO_T_JOGO1_idx` (`id_jogo` ASC) ,
...
CREATE TABLE IF NOT EXISTS `gamelistTEST`.`t_plataforma` (
  ...
  UNIQUE INDEX `nm_plataforma_UNIQUE` (`nm_plataforma` ASC) )
ENGINE = InnoDB
AUTO_INCREMENT = 12
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `gamelistTEST`.`t_jogo_adicionado` (
  ...
  `id_usuario` INT(11) NOT NULL,
  `id_jogo` INT(11) NOT NULL,
  INDEX `fk_t_jogo_adicionado_t_lista1_idx` (`id_lista` ASC) ,
  INDEX `fk_t_jogo_adicionado_t_usuario1_idx` (`id_usuario` ASC) ,
  INDEX `fk_t_jogo_adicionado_t_jogo1_idx` (`id_jogo` ASC) ,
...
CREATE TABLE IF NOT EXISTS `gamelistTEST`.`t_plataformas_jogaveis` (
  ...
  INDEX `fk_t_plataforma_has_t_jogo_t_jogo1_idx` (`id_jogo` ASC) ,
  INDEX `fk_t_plataforma_has_t_jogo_t_plataforma1_idx` (`id_plataforma` ASC) ,
